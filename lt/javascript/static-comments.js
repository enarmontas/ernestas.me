(function ($) {
  ...
  $('.js-form').submit(function () {
    ...
    $("#comment-form-submit").html(
      '<svg class="icon spin"><use xlink:href="#icon-loading"></use></svg> Siunčiama'
    );
    ...
    $.ajax({
      ...
      success: function (data) {
        showModal('Komentaras išsiųstas', 'Ačiū! Komentaras bus publikuotas po patvirtinimo.');
      ...
      error: function (err) {
        ...
        showModal('Klaida!', 'Įvyko klaida:<br>[' + ecode + ']');
